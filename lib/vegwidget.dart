...
class vegwidget extends StatefulWidget {
  const vegwidget({super.key});

  @override
  State<vegwidget> createState() => _homewidgetState();
}

class _homewidgetState extends State<vegwidget> {
  @override
  ...
  List decription = [
    ...
    "Loaded with antioxidants and fiber,Chinese cabbage is the perfect addition to your daily diet",
